...
import com.sannniu.ncore.db.entity.EntityMetadata;
import com.sannniu.ncore.db.entity.FieldMetadata;
import com.sannniu.ncore.db.exception.TADBException;
import com.sannniu.ncore.db.exception.TADBNotOpenException;
...
public class TASQLiteDatabase {
     ...
     * @throws TADBException 数据库连接不可用,没有连接或者数据库没有打开
     */
