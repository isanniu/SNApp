package com.sannniu.ncore.crash;
...
import com.sannniu.ncore.utils.FileUtil;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private OnCrashCallBack crashBack;
     ...
     * @param crashBack
     */
    public void init(Context ctx, OnCrashCallBack crashBack) {
        mContext = ctx;
    ...
    public boolean handleException(Throwable ex) {
        ...
        new Thread() {
            public void run() {
                Looper.prepare();
                ToastFactory.show(mContext,"Application error!");
                Looper.loop();
            }
        }.start();
        // 收集设备参数信息
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        if (Environment.getExternalStorageState().equals(
            ...
            try {
                fileName = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "crash" + File.separator + fileName;
